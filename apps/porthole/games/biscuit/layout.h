...
// one- to three-word tail ("happening.") into a short phrase, and the screen that gives them up (13 words or more at
// the widest names) keeps 10 or more. The gate holds every text to it, at the widest names and at short ones.
