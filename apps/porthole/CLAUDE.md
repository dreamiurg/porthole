...
- `games/biscuit/`: the RGB565 game. Its rules (`pet.h`), save and legacy migration are landed; the screens and `game.h`/`game.cpp` are still landing. Brief: `games/biscuit/CLAUDE.md`.
